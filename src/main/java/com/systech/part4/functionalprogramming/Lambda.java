...
public class Lambda {
    public static void main(String[] args) {
        ...
        CompareFunctions<Student,Student,Boolean> studentCompare3 = (Student studentOne, Student studentTwo) -> {
            // logic goes here
            System.out.println(studentOne.getFirstName());
            System.out.println(studentTwo.getFirstName());
        ...
        CompareFunctions<LocalDate,LocalDate,Boolean> dateCompare = (date1,date2) -> date1.isAfter(date2);
